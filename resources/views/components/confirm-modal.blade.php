...
<div class="relative z-50 h-auto w-auto" x-data="{ modalOpen: false }" @keydown.escape.window="modalOpen = false" x-cloak>
    <div @click="modalOpen=true">
        {{ $trigger }}
    </div>

    <template x-teleport="body">
        <div class="fixed left-0 top-0 z-[99] flex h-screen w-screen items-center justify-center overflow-y-auto"
            x-show="modalOpen">
            ...
            <div class="relative w-full bg-white px-7 py-6 shadow dark:bg-gray-700 sm:max-w-lg sm:rounded-lg"
                ...
                <div class="p-4 text-center md:p-5">
                    ...
                    <div class="flex justify-center gap-3" @click="modalOpen = false">
                        {{ $actions }}
                    </div>
                </div>
            </div>
