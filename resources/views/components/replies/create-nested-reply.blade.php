    ...
    @if (!$thread->isClosed())
        <div class="space-y-3 rounded-b-lg border-t border-gray-300 bg-gray-100 p-3 dark:border-gray-700 dark:bg-gray-800">
            <button
                ...
                x-show="!isReplying" @click="isReplying = true; $dispatch('focus-markdown-editor')">
                Write a reply
            </button>

            <div x-show="isReplying">
                <form class="space-y-3" id="create-child-form" wire:submit="createChild">
                    <x-markdown-editor height="h-32" placeholder="Write a reply" wire:model="childBody" />
