...
$refs.content.addEventListener('mouseleave', () => { tooltipVisible = false; });">
    <div class="absolute w-auto text-sm" x-ref="tooltip" x-show="tooltipVisible"
        :class="{
        ...
        x-cloak>
        <div class="relative rounded bg-gray-700 px-2 py-1 text-white" x-show="tooltipVisible" x-transition>
            <p class="block flex-shrink-0 whitespace-nowrap text-xs" x-text="tooltipText"></p>
            <div class="absolute inline-flex items-center justify-center overflow-hidden" x-ref="tooltipArrow"
                x-show="tooltipArrow"
                :class="{
                ...
                <div class="h-1.5 w-1.5 transform bg-gray-700"
                    :class="{
