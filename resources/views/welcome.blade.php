    ...
    <div
        ...
        <div class="mx-auto max-w-7xl p-6 lg:p-8">
            <div class="flex justify-center">
                <svg class="h-16 w-auto bg-gray-100 dark:bg-gray-900" viewBox="0 0 62 65" fill="none"
                    ...
                    <a class="duration-250 flex scale-100 rounded-lg bg-white from-gray-700/50 via-transparent p-6 shadow-2xl shadow-gray-500/20 transition-all focus:outline focus:outline-2 focus:outline-red-500 motion-safe:hover:scale-[1.01] dark:bg-gray-800/50 dark:bg-gradient-to-bl dark:shadow-none dark:ring-1 dark:ring-inset dark:ring-white/5"
                        ...
                        <div>
                            <div
                                ...
                                <svg class="h-7 w-7 stroke-red-500" xmlns="http://www.w3.org/2000/svg" fill="none"
                        ...
                        <svg class="mx-6 h-6 w-6 shrink-0 self-center stroke-red-500" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div>
                            ...
                            <p class="mt-4 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
                                Laravel's robust library of first-party tools and libraries, such as <a
                                    ...
                                    class="underline hover:text-gray-700 focus:rounded-sm focus:outline focus:outline-2 focus:outline-red-500 dark:hover:text-white"
                                    href="https://envoyer.io">Envoyer</a> help you take your projects to the next level.
                ...
                <div class="text-center text-sm text-gray-500 dark:text-gray-400 sm:text-start">
                    <div class="flex items-center gap-4">
                        <a class="group inline-flex items-center hover:text-gray-700 focus:rounded-sm focus:outline focus:outline-2 focus:outline-red-500 dark:hover:text-white"
                            ...
                            <svg class="-mt-px me-1 h-5 w-5 stroke-gray-400 group-hover:stroke-gray-600 dark:stroke-gray-600 dark:group-hover:stroke-gray-400"
